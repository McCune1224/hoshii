...
declare module '$env/static/private' {
	export const WISHLIST_DB: string;
	export const SESSION_DB: string;
	...
	export const npm_package_devDependencies_svelte_add: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_svelte_add: string;
